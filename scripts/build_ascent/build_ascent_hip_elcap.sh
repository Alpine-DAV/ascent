...
export CC=/usr/tce/packages/rocmcc/rocmcc-6.4.2-magic/bin/amdclang
export CXX=/usr/tce/packages/rocmcc/rocmcc-6.4.2-magic/bin/amdclang++
export ROCM_PATH=/usr/tce/packages/rocmcc/rocmcc-6.4.2-magic/
