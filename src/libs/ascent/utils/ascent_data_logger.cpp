...
DataLogger::DataLogger() : m_at_block_start(true), m_rank(0)
{
...
void DataLogger::open_entry(const std::string &entryName)
{
#ifdef ASCENT_LOGGING_ENABLED
    write_indent();
