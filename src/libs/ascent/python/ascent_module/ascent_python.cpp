...
//---------------------------------------------------------------------------//
static void PyAscent_Ascent_Error_To_PyErr(const conduit::Error &e)
{
...
// Helper that promotes ascent error to python error
//---------------------------------------------------------------------------//
static void PyAscent_Cpp_Error_To_PyErr(const char *msg)
{
    std::ostringstream oss;
...
//---------------------------------------------------------------------------//
static PyObject *PyAscent_Ascent_new(PyTypeObject *type,
...
//---------------------------------------------------------------------------//
static void PyAscent_Ascent_dealloc(PyAscent_Ascent *self)
{
    if (self->ascent != NULL)
    {
        delete self->ascent;
...
//---------------------------------------------------------------------------//
static int PyAscent_Ascent_init(PyAscent_Ascent *self,
                                PyObject *, // args -- unused
                                PyObject *) // kwds -- unused
{
...
//-----------------------------------------------------------------------------
static PyObject *
PyAscent_Ascent_open(PyAscent_Ascent *self, PyObject *args, PyObject *kwargs)
{
...
//-----------------------------------------------------------------------------
static PyObject *PyAscent_Ascent_publish(PyAscent_Ascent *self,
                                         PyObject *args,
                                         PyObject *kwargs)
{
...
//-----------------------------------------------------------------------------
static PyObject *PyAscent_Ascent_execute(PyAscent_Ascent *self,
                                         PyObject *args,
                                         PyObject *kwargs)
{
...
//-----------------------------------------------------------------------------
static PyObject *
PyAscent_Ascent_info(PyAscent_Ascent *self, PyObject *args, PyObject *kwargs)
{
...
//---------------------------------------------------------------------------//
static PyObject *PyAscent_Ascent_close(PyAscent_Ascent *self)
{
    try
    {
        self->ascent->close();
...
//---------------------------------------------------------------------------//
static PyObject *PyAscent_Ascent_str(PyAscent_Ascent *self)
{
...
static PyMethodDef PyAscent_Ascent_METHODS[] = {
    ...
    {"info",
     ...
     "{todo}"                                                            },
    //-----------------------------------------------------------------------//
    {"close",   (PyCFunction)PyAscent_Ascent_close, METH_NOARGS, "{todo}"},
    //-----------------------------------------------------------------------//
...
// ascent::about
//---------------------------------------------------------------------------//
static PyObject *PyAscent_about()
{
...
//---------------------------------------------------------------------------//
static PyObject *PyAscent_execute_callback(PyObject *self, PyObject *args)
{
    char *callback_name;
...
static PyMethodDef ascent_python_funcs[] = {
    //-----------------------------------------------------------------------//
    {"about",            (PyCFunction)PyAscent_about, METH_NOARGS,  NULL},
    //-----------------------------------------------------------------------//
    {"execute_callback",
...
#if defined(IS_PY3K)
//---------------------------------------------------------------------------//
static int ascent_python_traverse(PyObject *m, visitproc visit, void *arg)
{
...
//---------------------------------------------------------------------------//
static int ascent_python_clear(PyObject *m)
{
...
//---------------------------------------------------------------------------//
#if defined(IS_PY3K)
    PyObject *ASCENT_PYTHON_API
    PyInit_ascent_python(void)
#else
    void ASCENT_PYTHON_API
    initascent_python(void)
#endif
//---------------------------------------------------------------------------//
{
    //-----------------------------------------------------------------------//
...
#else
    PyObject *py_module =
        Py_InitModule((char *)"ascent_python", ascent_python_funcs);
#endif
    ...
    st->error = PyErr_NewException((char *)"ascent_python.Error", NULL, NULL);
    if (st->error == NULL)
    {
        Py_DECREF(py_module);
        PY_MODULE_INIT_RETURN_ERROR;
    ...
    PyModule_AddObject(py_module, "Ascent", (PyObject *)&PyAscent_Ascent_TYPE);
