...
public:
    ...
    BlueprintToVTKmDataSet(const conduit::Node &n,
                           bool zero_copy,
                           const std::string &topo_name);
...
private:
    ...
    static vtkm::cont::DataSet *
    UniformBlueprintToVTKmDataSet(const std::string &coords_name,
    ...
    static vtkm::cont::DataSet *
    RectilinearBlueprintToVTKmDataSet(const std::string &coords_name,
                                      const conduit::Node &n_coords,
                                      const std::string &topo_name,
                                      const conduit::Node &n_topo,
                                      int &neles,
    ...
    static vtkm::cont::DataSet *
    StructuredBlueprintToVTKmDataSet(const std::string &coords_name,
                                     const conduit::Node &n_coords,
                                     const std::string &topo_name,
                                     const conduit::Node &n_topo,
                                     int &neles,
    ...
    static vtkm::cont::DataSet *
    PointsImplicitBlueprintToVTKmDataSet(const std::string &coords_name,
                                         const conduit::Node &n_coords,
                                         const std::string &topo_name,
                                         const conduit::Node &n_topo,
                                         int &neles,
    ...
    static vtkm::cont::DataSet *
    UnstructuredBlueprintToVTKmDataSet(const std::string &coords_name,
                                       const conduit::Node &n_coords,
                                       const std::string &topo_name,
                                       const conduit::Node &n_topo,
                                       int &neles,
