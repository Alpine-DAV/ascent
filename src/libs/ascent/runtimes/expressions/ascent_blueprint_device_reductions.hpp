...
//----------------------
conduit::Node ASCENT_API
field_reduction_max(const conduit::Node &field,
                    const std::string &component = "");

conduit::Node ASCENT_API
field_reduction_min(const conduit::Node &field,
                    const std::string &component = "");

conduit::Node ASCENT_API
field_reduction_sum(const conduit::Node &field,
                    const std::string &component = "");

conduit::Node ASCENT_API
field_reduction_nan_count(const conduit::Node &field,
                          const std::string &component = "");

// count of all inf or -inf
conduit::Node ASCENT_API
field_reduction_inf_count(const conduit::Node &field,
                          const std::string &component = "");
