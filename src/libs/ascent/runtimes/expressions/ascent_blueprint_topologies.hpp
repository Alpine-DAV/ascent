...
template <typename T, size_t N> class PointTopology : public Topology
{
...
template <typename T, size_t N> class UniformTopology : public Topology
{
    static_assert(N >= 1 && N <= 3,
                  "Number of Topology dimensions must be between 1 and 3.");
...
template <typename T, size_t N> class RectilinearTopology : public Topology
{
    static_assert(N >= 1 && N <= 3,
                  "Number of Topology dimensions must be between 1 and 3.");
...
template <typename T, size_t N> class StructuredTopology : public Topology
{
    static_assert(N >= 1 && N <= 3,
                  "Number of Topology dimensions must be between 1 and 3.");

public:
    StructuredTopology(const std::string &topo_name,
                       const conduit::Node &domain);
    virtual std::array<conduit::float64, 3>
    vertex_location(const size_t index) const;
    virtual std::array<conduit::float64, 3>
...
template <typename T, size_t N> class UnstructuredTopology : public Topology
{
    static_assert(N >= 1 && N <= 3,
                  "Number of Topology dimensions must be between 1 and 3.");
