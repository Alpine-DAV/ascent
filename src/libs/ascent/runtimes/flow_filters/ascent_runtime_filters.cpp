...
void register_builtin()
{
    ...
    AscentRuntime::register_filter_type<BlueprintFlatten>("extracts",
                                                          "flatten");
    ...
    AscentRuntime::register_filter_type<FilterQuery>("transforms",
                                                     "expression");
    ...
    AscentRuntime::register_filter_type<BlueprintPartition>("transforms",
                                                            "partition");
    AscentRuntime::register_filter_type<AddFields>("transforms", "add_fields");
    AscentRuntime::register_filter_type<PowerOfField>("transforms",
                                                      "power_of_field");
    ...
    AscentRuntime::register_filter_type<VTKHAddDomains>("transforms",
                                                        "add_domain_ids");
    AscentRuntime::register_filter_type<VTKHAddRanks>("transforms",
                                                      "add_mpi_ranks");
    AscentRuntime::register_filter_type<VTKHClip>("transforms", "clip");
    AscentRuntime::register_filter_type<VTKHClipWithField>("transforms",
                                                           "clip_with_field");
    AscentRuntime::register_filter_type<VTKHCleanGrid>("transforms",
                                                       "clean_grid");
    AscentRuntime::register_filter_type<VTKHExternalSurfaces>(
        "transforms", "external_surfaces");
    AscentRuntime::register_filter_type<VTKHGhostStripper>("transforms",
                                                           "ghost_stripper");
    AscentRuntime::register_filter_type<VTKHIsoVolume>("transforms",
                                                       "isovolume");
    AscentRuntime::register_filter_type<VTKHLagrangian>("transforms",
                                                        "lagrangian");
    ...
    AscentRuntime::register_filter_type<VTKHMarchingCubes>("transforms",
                                                           "contour");
    AscentRuntime::register_filter_type<VTKHThreshold>("transforms",
                                                       "threshold");
    AscentRuntime::register_filter_type<VTKHSlice>("transforms", "slice");
    AscentRuntime::register_filter_type<VTKHAutoSliceLevels>("transforms",
                                                             "auto_slice");
    AscentRuntime::register_filter_type<VTKH3Slice>("transforms", "3slice");
    AscentRuntime::register_filter_type<VTKHCompositeVector>(
        "transforms", "composite_vector");
    AscentRuntime::register_filter_type<VTKHVectorComponent>(
        "transforms", "vector_component");
    AscentRuntime::register_filter_type<VTKHNoOp>("transforms", "noop");
    AscentRuntime::register_filter_type<VTKHRecenter>("transforms",
                                                      "recenter");
    AscentRuntime::register_filter_type<VTKHVectorMagnitude>(
        "transforms", "vector_magnitude");
    AscentRuntime::register_filter_type<VTKHHistSampling>("transforms",
                                                          "histsampling");
    AscentRuntime::register_filter_type<VTKHQCriterion>("transforms",
                                                        "qcriterion");
    AscentRuntime::register_filter_type<VTKHStats>("extracts", "statistics");
    AscentRuntime::register_filter_type<VTKHHistogram>("extracts",
                                                       "histogram");
    AscentRuntime::register_filter_type<VTKHGradient>("transforms",
                                                      "gradient");
    AscentRuntime::register_filter_type<VTKHDivergence>("transforms",
                                                        "divergence");
    AscentRuntime::register_filter_type<VTKHVorticity>("transforms",
                                                       "vorticity");
    AscentRuntime::register_filter_type<VTKHTransform>("transforms",
                                                       "transform");
    AscentRuntime::register_filter_type<VTKHScale>("transforms", "scale");
    AscentRuntime::register_filter_type<VTKHProject2d>("transforms",
                                                       "project_2d");
    AscentRuntime::register_filter_type<VTKHTriangulate>("transforms",
                                                         "triangulate");
    AscentRuntime::register_filter_type<VTKHParticleAdvection>(
        "transforms", "particle_advection");
    AscentRuntime::register_filter_type<VTKHStreamline>("transforms",
                                                        "streamline");
    AscentRuntime::register_filter_type<VTKHWarpXStreamline>(
        "transforms", "warpx_streamline");
    AscentRuntime::register_filter_type<VTKHUniformGrid>("transforms",
                                                         "uniform_grid");
...
#if defined(ASCENT_DRAY_ENABLED)
    AscentRuntime::register_filter_type<DRayPseudocolor>("extracts",
                                                         "dray_pseudocolor");
    ...
    AscentRuntime::register_filter_type<DRayProject2d>("transforms",
                                                       "dray_project_2d");
    AscentRuntime::register_filter_type<DRayProjectColors2d>(
        "transforms", "dray_project_colors_2d");
    AscentRuntime::register_filter_type<DRayReflect>("transforms",
                                                     "dray_reflect");
    AscentRuntime::register_filter_type<DRayVectorComponent>(
        "transforms", "dray_vector_component");
#endif
