                   ...
                   bool supports_expressions)
{
    ...
    {
        info["errors"].append() =
            "Missing required numeric parameter '" + path + "'";
        res = false;
    }
    ...
    if (params.has_path(path))
    {
        ...
        if (!params[path].dtype().is_number() && !is_expr)
        {
            ...
            {
                std::string msg =
                    "Expected numeric parameter '" + path + " : " +
                    params[path].to_yaml() +
                  ...
                  bool required)
{
    ...
    {
        info["errors"].append() =
            "Missing required string parameter '" + path + "'";
        res = false;
    }
    ...
    {
        std::string msg =
            "Expected string parameter '" + path + "' is not a string'";
        info["errors"].append() = msg;
        res = false;
    }
    return res;
...
bool check_bool(const std::string path,
                const conduit::Node &params,
                conduit::Node &info,
                bool required)
{
    ...
    {
        info["errors"].append() =
            "Missing required bool string parameter '" + path + "'";
        res = false;
    }
...
//-----------------------------------------------------------------------------
bool check_object(const std::string path,
                  const conduit::Node &params,
                  conduit::Node &info,
                  bool required)
{
    ...
    {
        info["errors"].append() =
            "Missing required object parameter '" + path + "'";
        res = false;
    }
    ...
    if (params.has_path(path))
    {
        ...
        {
            std::string msg =
                "Expected object parameter '" + path + "' is not an object";
            info["errors"].append() = msg;
            res = false;
        }
        ...
        {
            std::string msg =
                "Expected object parameter '" + path + "' has no children";
            info["errors"].append() = msg;
            res = false;
        }
    }
...
//-----------------------------------------------------------------------------
bool check_list(const std::string path,
                const conduit::Node &params,
                conduit::Node &info,
                bool required)
{
    ...
    {
        info["errors"].append() =
            "Missing required list parameter '" + path + "'";
        res = false;
    }
    ...
    if (params.has_path(path))
    {
        ...
        {
            std::string msg =
                "Expected list parameter '" + path + "' is not a list";
            info["errors"].append() = msg;
            res = false;
        }
        else if (params[path].number_of_children() == 0)
        {
            std::string msg =
                "Expected list parameter '" + path + "' has no children";
            info["errors"].append() = msg;
            res = false;
        }
    }
                 ...
                 const std::string path_prefix)
{
    ...
    for (int i = 0; i < num_children; ++i)
    {
        ...
        for (int p = 0; p < num_ignore_paths; ++p)
        {
            ...
            if (child.path().compare(0, ignore_path.length(), ignore_path) ==
                0)
            {
                skip = true;
                break;
...
//-----------------------------------------------------------------------------
template <typename T> T conduit_cast(const conduit::Node &node);

//-----------------------------------------------------------------------------
template <> int conduit_cast<int>(const conduit::Node &node)
{
    return node.to_int32();
}

//-----------------------------------------------------------------------------
template <> double conduit_cast<double>(const conduit::Node &node)
{
    return node.to_float64();
}

//-----------------------------------------------------------------------------
template <> float conduit_cast<float>(const conduit::Node &node)
{
...
T get_value(const conduit::Node &node, DataObject *dataset)
{
    ...
    if (node.dtype().is_string())
    {
        ...
        {
            ASCENT_ERROR("expression '"
                         << expr << "' resulted in multiple values."
