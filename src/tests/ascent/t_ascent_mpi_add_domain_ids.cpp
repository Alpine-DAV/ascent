...
//-----------------------------------------------------------------------------
///
/// file: t_ascent_mpi_add_domain_ids.cpp
///
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------
TEST(ascent_mpi_add_domain_ids, test_mpi_add_domain_ids)
{
    //
    //Set Up MPI
    //
...
//    data.print();
    ...
    ASCENT_INFO("Testing adding domain ids to conduit::blueprint spiral input\n");
