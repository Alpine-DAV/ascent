...
//-----------------------------------------------------------------------------
TEST(ascent_sample_regular_grid, test_sample_grid_smaller_than_input)
{
    Node n;
    ascent::about(n);
    ...
    string output_file = conduit::utils::join_file_path(output_path,"tout_sample_smaller_grid");
...
//-----------------------------------------------------------------------------
TEST(ascent_sample_regular_grid, test_sample_grid_larger_than_input)
{
    Node n;
    ascent::about(n);
    // only run this test if ascent was built with vtkm support
