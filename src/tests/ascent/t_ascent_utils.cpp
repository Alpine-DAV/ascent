...
TEST(ascent_utils, ascent_string_fmt_basic)
{
    ...
    std::string expected_result = conduit::utils::join_file_path(".", "t_output_path_100_00012_3.1416");
...
TEST(ascent_utils, ascent_string_fmt_cycle_integer_fmt)
{
    ...
    std::string expected_result = conduit::utils::join_file_path(".", "t_output_path_cycle_int_100_0000000000000000000000000000000000000000100_100_100");
...
TEST(ascent_utils, ascent_string_fmt_cycle_float_fmt)
{
    ...
    std::string expected_result_float = conduit::utils::join_file_path(".", "t_output_path_cycle_float_100.00_100.00");
    ...
    std::string expected_result_scientific = conduit::utils::join_file_path(".", "t_output_path_cycle_scientific_1.00e+02_1.00E+02");
    ...
    // Test g format
    std::string expected_result_g = conduit::utils::join_file_path(".", "t_output_path_cycle_g_1e+02_1E+02");
...
TEST(ascent_utils, ascent_string_fmt_time_float_fmt)
{
    ...
    // Test floating point formats
    std::string expected_result_float = conduit::utils::join_file_path(".", "t_output_path_time_float_3.14_3.14");
    std::string result_float = ascent::expand_path_special_variables("t_output_path_time_float_{time:02.02f}_{time:02.02F}", "", -1);
    std::cout << result_float << std::endl;
    EXPECT_TRUE(expected_result_float == result_float);

    // Test scientific notation format
    std::string expected_result_scientific = conduit::utils::join_file_path(".", "t_output_path_time_scientific_3.14e+00_3.14E+00");
    ...
    // Test g format
    std::string expected_result_g = conduit::utils::join_file_path(".", "t_output_path_time_g_003.1_3.1");
...
TEST(ascent_utils, ascent_string_fmt_time_integer_fmt)
{
    ...
    std::string expected_result = conduit::utils::join_file_path(".", "t_output_path_time_int_003_0000000000000000000000000000000000000000003_003_003");
...
TEST(ascent_utils, ascent_string_fmt_family)
{
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        std::string expected_pattern = conduit::utils::join_file_path(".", "t_output_path_family_%03d_%05.2f_%05.03g");
...
{
    std::string expected_result = conduit::utils::join_file_path(".", "t_output_path_none_000100");
...
TEST(ascent_utils, ascent_string_fmt_just_type)
{
    ...
    std::string expected_result = conduit::utils::join_file_path(".", "t_output_path_none_100.000000_3_6.000000");
    std::cout << result << std::endl;
...
TEST(ascent_utils, ascent_string_fmt_no_format)
{
    ...
    std::string expected_result = conduit::utils::join_file_path(".", "t_output_path_none_000100_3.14159_000008");
    std::cout << result << std::endl;
...
TEST(ascent_utils, ascent_string_fmt_no_format_colon)
{
    ...
    std::string result = ascent::expand_path_special_variables("t_output_path_none_{cycle:}_{time:}_{family:}", "", -1);
    std::string expected_result = conduit::utils::join_file_path(".", "t_output_path_none_000100_3.14159_000010");
    std::cout << result << std::endl;
...
TEST(ascent_utils, ascent_string_fmt_family_check_extension_added_already) {
    string output_path = prepare_output_dir();
    Metadata::n_metadata["family_value_seed"] = 0;
    Metadata::n_metadata["default_dir"] = output_path;

    string pre_existing_file_name_1 = conduit::utils::join_file_path(output_path, "t_output_path_family_check_01000_with_ext.root");
    string pre_existing_file_name_2 = conduit::utils::join_file_path(output_path, "t_output_path_family_check_01001_with_ext.root");
    std::ofstream file_1(pre_existing_file_name_1);
    if (file_1.is_open()) {
        file_1 << "This is a fake file for testing.\n";
        file_1.close();
    ...
    string output_file = "t_output_path_family_check_{family:05d}_with_ext.root";
    std::string expected_result = conduit::utils::join_file_path(output_path, "t_output_path_family_check_01002_with_ext.root");
...
TEST(ascent_utils, ascent_string_fmt_family_check_extension_sometimes_added) {
    ...
    string output_file = conduit::utils::join_file_path(output_path, "t_output_path_family_check_{family:03d}_sometimes_ext");

    std::string expected_result_1 = conduit::utils::join_file_path(output_path, "t_output_path_family_check_000_sometimes_ext.root");
    ...
    std::string expected_result_2 = conduit::utils::join_file_path(output_path, "t_output_path_family_check_001_sometimes_ext");
...
TEST(ascent_utils, ascent_direct_to_default_dir) {
    string output_path = prepare_output_dir();
    Metadata::n_metadata["default_dir"] = output_path;

    std::string result = ascent::expand_path_special_variables("t_output_filename", "", -1);
    std::string expected_result = conduit::utils::join_file_path(output_path, "t_output_filename_000100");
    std::cout << result << std::endl;
