...
TEST(ascent_gradient, vel_gradient)
{
    ...
    ASCENT_INFO("Testing the divergence of a field");


    string output_path = prepare_output_dir();
    string output_file = conduit::utils::join_file_path(output_path,"tout_divergence_vel");
    ...
    pipelines["pl1/f2/type"] = "divergence";
    conduit::Node &params2 = pipelines["pl1/f2/params"];
    params2["field"] = "vel";                  // name of the input field
    params2["output_name"] = "vel_divergence";   // name of the output field
    params2["use_cell_gradient"] = "false";

    conduit::Node scenes;
    scenes["s1/plots/p1/type"]         = "pseudocolor";
    scenes["s1/plots/p1/field"] = "vel_divergence";
