...
TEST(ascent_render_3d, test_render_3d_multi_render_default_runtime)
{
    ...
    contour_params["levels"] = 2.;
    // pipeline 1
    pipelines["pl2/f1/type"] = "clip";
    // filter knobs
    conduit::Node &clip_params2 = pipelines["pl2/f1/params"];
    //clip_params2["field"] = "braid";
    clip_params2["sphere/radius"] = 10.;
    clip_params2["invert"] = "true";
    clip_params2["sphere/center/x"] = 0.;
    clip_params2["sphere/center/y"] = 0.;
    clip_params2["sphere/center/z"] = 0.;


    conduit::Node scenes;
    // plot 1
    //scenes["s1/plots/p1/type"]  = "anari_pseudocolor";
    //scenes["s1/plots/p1/field"] = "braid";
    //scenes["s1/plots/p1/pipeline"] = "pl1";
    //scenes["s1/plots/p1/color_table/name"]  = "Cool To Warm";
    //plot 2
    scenes["s1/plots/p2/type"]         = "anari_pseudocolor";
    //scenes["s1/plots/p2/type"]         = "anari_volume";
...
//
    ...
    extracts["e1/params/path"] = "contour";
...
TEST(ascent_render_3d, test_render_3d_mesh_bg_fg_color)
{
    ...
    ASCENT_INFO("Testing 3D Rendering of a mesh with custom bg/fg colors");


    string output_path = prepare_output_dir();
    string output_file = conduit::utils::join_file_path(output_path,"tout_render_3d_mesh_bg_fg_colors");
    ...
    // check that we created an image
    EXPECT_TRUE(check_test_image(output_file));
    std::string msg = "An example of rendering a mesh with custom background and foreground colors.";
    ASCENT_ACTIONS_DUMP(actions,output_file,msg);
}
//-----------------------------------------------------------------------------
