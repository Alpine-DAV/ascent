...
TEST(ascent_sample_regular_grid, test_uniform_grid_smaller_by1_than_input)
{
    ...
    string output_file = conduit::utils::join_file_path(output_path,"tout_sample_smaller_by1_grid");
    ...
    params["dims/k"] = EXAMPLE_MESH_SIDE_DIM-1;
    params["origin/x"] = 0.0;        
    params["origin/y"] = 0.0;        
    params["origin/z"] = 0.0;        
...
TEST(ascent_sample_regular_grid, test_uniform_grid_smaller_by5_than_input)
{
    ...
    string output_path = prepare_output_dir();
    string output_file = conduit::utils::join_file_path(output_path,"tout_sample_smaller_by5_grid");
...
TEST(ascent_sample_regular_grid, test_uniform_grid_smaller_by10_than_input)
{
    ...
    string output_path = prepare_output_dir();
    string output_file = conduit::utils::join_file_path(output_path,"tout_sample_smaller_by10_grid");
...
TEST(ascent_sample_regular_grid, test_uniform_grid_equal_size_input)
{
    ...
    string output_path = prepare_output_dir();
    string output_file = conduit::utils::join_file_path(output_path,"tout_sample_equal_grid");
...
TEST(ascent_sample_regular_grid, test_uniform_grid_larger_by5_than_input)
{
    ...
    string output_path = prepare_output_dir();
    string output_file = conduit::utils::join_file_path(output_path,"tout_sample_larger_by5_grid");
...
TEST(ascent_sample_regular_grid, test_uniform_grid_larger_by5_than_input_large_invalid_value)
{
    ...
    string output_path = prepare_output_dir();
    string output_file = conduit::utils::join_file_path(output_path,"tout_sample_larger_by5_grid_with_invalid_value");
